...
from roulette_menu import roulette_menu_ruler, get_back_menu  
...
async def rules(call: types.CallbackQuery):
    await call.message.edit_text(
        textwrap.dedent(
            ...
            Каждому игроку будет даваться рандомно 3 предмета(не обязательно одинаковых), описанных ниже.
            Предметы можно использовать в любой момент во время своего хода, но у вас НЕ МОЖЕТ БЫТЬ БОЛЬШЕ <b>9-И</b> ПРЕДМЕТОВ
            ...
            • <b>Зажигательный снаряд🔥</b>: игрок может положить его в револьвер. Если следующий патрон боевой, револьвер нанесет 2 урона вместо 1. Если холостой — ничего не произойдет.
